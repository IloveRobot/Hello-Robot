...
unsigned char FW[] = {0xAA,0x7F,0x01,0x01,0x01,0x01,0x01,0x00,0x01,0x03,0xE8,0x03,0xE8,0x55,0xC0,0x7C};//复位
unsigned char QJ[] = {0xAA,0x7F,0x01,0x00,0x01,0x01,0x01,0x00,0x01,0x03,0xE8,0x03,0xE8,0x55,0xC4,0x80};//前进
unsigned char JS[] = {0xAA,0x7F,0x01,0x00,0x01,0x01,0x01,0x00,0x01,0x09,0xE8,0x09,0xE8,0x55,0x7C,0x83};//加速
unsigned char HT[] = {0xAA,0x7F,0x01,0x00,0x01,0x01,0x01,0x01,0x00,0x03,0xE8,0x03,0xE8,0x55,0xD5,0x91};//后退
unsigned char ZZ[] = {0xAA,0x7F,0x01,0x00,0x01,0x01,0x01,0x01,0x01,0x03,0xE8,0x03,0xE8,0x55,0xD4,0x40};//左转
unsigned char YZ[] = {0xAA,0x7F,0x01,0x00,0x01,0x01,0x01,0x00,0x00,0x03,0xE8,0x03,0xE8,0x55,0xC5,0x51};//右转
...
int main (int argc, char* argv[]){
    ...
    ros::Subscriber sub = nh.subscribe("/turtle1/cmd_vel", 1000, callback);//用/turtle1/cmd_vel做测试哈
